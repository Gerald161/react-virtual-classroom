    ...
    return ( 
        <div className="login_section">
            ...
            <div className="second_section">
                <h1>Join our community of learning</h1>

                <form method="post" action="#" onSubmit={(e)=>{e.preventDefault()}}>
                    <input type="text" ref={userNameRef} onKeyUp={
                        (e)=>{
                    ...
                    <input type="text" ref={emailFieldRef} onKeyUp={
                        (e)=>{
                            if(emailError !== false){
                                setemailError(false);
                            }
                    ...
                    <input type="text" ref={telephoneRef} onKeyUp={(e)=>{checkFieldValidation(e)}} name="telephone" placeholder="Phone Number" maxLength={10} required/>
